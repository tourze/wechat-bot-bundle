...
use Tourze\WechatBotBundle\Request\Login\GetDeviceOfflineInfoRequest;

/**
 * @internal
 */
#[CoversClass(GetDeviceOfflineInfoRequest::class)]
final class GetDeviceOfflineInfoRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetDeviceOfflineInfoRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetDeviceOfflineInfoRequest(
            $this->apiAccount,
            'device123'
        );
    }
