 ...
 * @internal
 */
#[CoversClass(ResetDeviceRequest::class)]
final class ResetDeviceRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ResetDeviceRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ResetDeviceRequest(
            $this->apiAccount,
            'device123'
        );
    }
