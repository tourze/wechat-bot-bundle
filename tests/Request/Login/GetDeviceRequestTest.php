...
use Tourze\WechatBotBundle\Request\Login\GetDeviceRequest;

/**
 * @internal
 */
#[CoversClass(GetDeviceRequest::class)]
final class GetDeviceRequestTest extends RequestTestCase
{
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetDeviceRequest(
            $this->apiAccount,
            'device123'
        );
    }
