...
use Tourze\WechatBotBundle\Request\Login\GetSpecificDeviceRequest;

/**
 * @internal
 */
#[CoversClass(GetSpecificDeviceRequest::class)]
final class GetSpecificDeviceRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetSpecificDeviceRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetSpecificDeviceRequest(
            $this->apiAccount,
            'device123'
        );
    }
