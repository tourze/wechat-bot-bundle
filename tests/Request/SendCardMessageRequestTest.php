...
use Tourze\WechatBotBundle\Request\SendCardMessageRequest;

/**
 * @internal
 */
#[CoversClass(SendCardMessageRequest::class)]
final class SendCardMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SendCardMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SendCardMessageRequest(
            $this->apiAccount,
            'device123',
            'wxid123',
            'cardwxid123'
