 ...
 * @internal
 */
#[CoversClass(UpdateFriendTagRequest::class)]
final class UpdateFriendTagRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private UpdateFriendTagRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new UpdateFriendTagRequest(
            $this->apiAccount,
            'device123',
            'tag123',
            'Updated Tag Name'
