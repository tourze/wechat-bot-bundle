 ...
 * @internal
 */
#[CoversClass(DeleteFriendTagRequest::class)]
final class DeleteFriendTagRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private DeleteFriendTagRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new DeleteFriendTagRequest(
            $this->apiAccount,
            'device123',
            'tag123'
        );
