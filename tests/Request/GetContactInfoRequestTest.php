 ...
 * @internal
 */
#[CoversClass(GetContactInfoRequest::class)]
final class GetContactInfoRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetContactInfoRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetContactInfoRequest(
            $this->apiAccount,
            'device123',
            'wxid_test123'
        );
    ...
    {
        $this->assertEquals('wxid_test123', $this->request->getWxId());
    }
    ...
    public function testGetRequestOptions(): void
    {
        ...
        $this->assertEquals('wxid_test123', $options['query']['wxId']);
    }

    public function testGetRequestPath(): void
    {
        $this->assertEquals('open/getContactInfo', $this->request->getRequestPath());
    }
}
