 ...
 * @internal
 */
#[CoversClass(UpdateFriendRemarkRequest::class)]
final class UpdateFriendRemarkRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private UpdateFriendRemarkRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new UpdateFriendRemarkRequest(
            $this->apiAccount,
            'device123',
            'wxid_friend123',
            'New Remark'
    ...
    {
        $this->assertEquals('New Remark', $this->request->getRemark());
    }
    ...
    public function testGetRequestOptions(): void
    {
        ...
        $this->assertEquals('New Remark', $options['json']['remark']);
    }

    public function testGetRequestPath(): void
    {
        $this->assertEquals('open/updateFriendRemark', $this->request->getRequestPath());
    }
}
