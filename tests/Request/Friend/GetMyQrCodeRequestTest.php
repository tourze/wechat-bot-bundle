 ...
 * @internal
 */
#[CoversClass(GetMyQrCodeRequest::class)]
final class GetMyQrCodeRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetMyQrCodeRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetMyQrCodeRequest(
            $this->apiAccount,
            'device123'
        );
    }
    ...
    {
        $this->assertEquals('open/getMyQrCode', $this->request->getRequestPath());
    }
}
