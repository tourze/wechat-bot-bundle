...
final class LeaveGroupRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private LeaveGroupRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new LeaveGroupRequest(
            $this->apiAccount,
            'device123',
            'chatroom456@chatroom'
        );
    }
    ...
    public function testGetRequestOptions(): void
    {
        ...
        $this->assertEquals('chatroom456@chatroom', $options['json']['chatRoomId']);
    }
    ...
    {
        $this->assertEquals('chatroom456@chatroom', $this->request->getChatRoomId());
    }

    public function testGetRequestPath(): void
    {
        $this->assertEquals('open/quitChatRoom', $this->request->getRequestPath());
    }
}
