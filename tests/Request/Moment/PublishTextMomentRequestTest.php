 ...
 * @internal
 */
#[CoversClass(PublishTextMomentRequest::class)]
final class PublishTextMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private PublishTextMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new PublishTextMomentRequest(
            $this->apiAccount,
            'device123',
            'Test moment content'
        );
