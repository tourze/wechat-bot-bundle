 ...
 * @internal
 */
#[CoversClass(PublishLinkMomentRequest::class)]
final class PublishLinkMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private PublishLinkMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new PublishLinkMomentRequest(
            $this->apiAccount,
            'device123',
            'https://example.com',
            'Test Link Title'
