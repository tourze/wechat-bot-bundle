 ...
 * @internal
 */
#[CoversClass(GetMomentDetailRequest::class)]
final class GetMomentDetailRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetMomentDetailRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetMomentDetailRequest(
            $this->apiAccount,
            'device123',
            'moment123'
        );
