 ...
 * @internal
 */
#[CoversClass(HideMomentRequest::class)]
final class HideMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private HideMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new HideMomentRequest(
            $this->apiAccount,
            'device123',
            'moment123'
        );
