 ...
 * @internal
 */
#[CoversClass(LikeMomentRequest::class)]
final class LikeMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private LikeMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new LikeMomentRequest(
            $this->apiAccount,
            'device123',
            'moment123'
        );
