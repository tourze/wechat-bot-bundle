 ...
 * @internal
 */
#[CoversClass(ShowMomentRequest::class)]
final class ShowMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ShowMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ShowMomentRequest(
            $this->apiAccount,
            'device123',
            'moment123'
        );
