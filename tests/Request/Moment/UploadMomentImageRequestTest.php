 ...
 * @internal
 */
#[CoversClass(UploadMomentImageRequest::class)]
final class UploadMomentImageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private UploadMomentImageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new UploadMomentImageRequest(
            $this->apiAccount,
            'device123',
