 ...
 * @internal
 */
#[CoversClass(DownloadMomentVideoRequest::class)]
final class DownloadMomentVideoRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private DownloadMomentVideoRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new DownloadMomentVideoRequest(
            $this->apiAccount,
            'device123',
