 ...
 * @internal
 */
#[CoversClass(DeleteMomentRequest::class)]
final class DeleteMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private DeleteMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new DeleteMomentRequest(
            $this->apiAccount,
            'device123',
            'moment123'
        );
