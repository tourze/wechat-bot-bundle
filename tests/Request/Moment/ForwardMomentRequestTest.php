 ...
 * @internal
 */
#[CoversClass(ForwardMomentRequest::class)]
final class ForwardMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ForwardMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ForwardMomentRequest(
            $this->apiAccount,
            'device123',
            'moment123'
        );
