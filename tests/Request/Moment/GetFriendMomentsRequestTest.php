 ...
 * @internal
 */
#[CoversClass(GetFriendMomentsRequest::class)]
final class GetFriendMomentsRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetFriendMomentsRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetFriendMomentsRequest(
            $this->apiAccount,
            'device123',
            'friend_wx_id_123'
        );
