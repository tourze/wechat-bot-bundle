 ...
 * @internal
 */
#[CoversClass(CommentMomentRequest::class)]
final class CommentMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private CommentMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new CommentMomentRequest(
            $this->apiAccount,
            'device123',
            'moment123',
