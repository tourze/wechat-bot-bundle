 ...
 * @internal
 */
#[CoversClass(GetMomentsRequest::class)]
final class GetMomentsRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetMomentsRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetMomentsRequest(
            $this->apiAccount,
            'device123'
        );
    }
