 ...
 * @internal
 */
#[CoversClass(PublishImageMomentRequest::class)]
final class PublishImageMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private PublishImageMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new PublishImageMomentRequest(
            $this->apiAccount,
            'device123',
            ['image123', 'image456']
        );
