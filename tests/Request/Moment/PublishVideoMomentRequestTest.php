 ...
 * @internal
 */
#[CoversClass(PublishVideoMomentRequest::class)]
final class PublishVideoMomentRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private PublishVideoMomentRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $tempVideoFile = tempnam(sys_get_temp_dir(), 'test_video_') . '.mp4';
        file_put_contents($tempVideoFile, 'fake video content');
        $this->request = new PublishVideoMomentRequest(
            $this->apiAccount,
            'device123',
            $tempVideoFile
        );
