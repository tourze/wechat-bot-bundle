...
use Tourze\WechatBotBundle\Request\SendVideoMessageRequest;

/**
 * @internal
 */
#[CoversClass(SendVideoMessageRequest::class)]
final class SendVideoMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SendVideoMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SendVideoMessageRequest(
            $this->apiAccount,
            'device123',
            'wx_id_123',
            '/path/to/video.mp4',
