...
final class DownloadVideoRequestTest extends RequestTestCase
{
    ...
    public function testGetRequestOptions(): void
    {
        ...
        $this->assertStringContainsString('bufId=buf_video123', $body);
        $this->assertStringContainsString('msgId=msg_456', $body);
        $this->assertStringContainsString('fromUser=wxid_sender789', $body);
    }

    public function testGetRequestPath(): void
    {
        $this->assertEquals('open/downloadVideo', $this->request->getRequestPath());
    }
}
