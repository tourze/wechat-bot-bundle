...
use Tourze\WechatBotBundle\Request\ConfirmLoginShortLinkRequest;

/**
 * @internal
 */
#[CoversClass(ConfirmLoginShortLinkRequest::class)]
final class ConfirmLoginShortLinkRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ConfirmLoginShortLinkRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ConfirmLoginShortLinkRequest(
            $this->apiAccount,
            'device123'
        );
    }
