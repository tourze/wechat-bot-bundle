...
use Tourze\WechatBotBundle\Request\SendVoiceMessageRequest;

/**
 * @internal
 */
#[CoversClass(SendVoiceMessageRequest::class)]
final class SendVoiceMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SendVoiceMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SendVoiceMessageRequest(
            $this->apiAccount,
            'device123',
            'wx_id_123',
