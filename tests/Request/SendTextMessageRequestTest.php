 ...
 * @internal
 */
#[CoversClass(SendTextMessageRequest::class)]
#[RunTestsInSeparateProcesses]
final class SendTextMessageRequestTest extends AbstractIntegrationTestCase
{
    ...
    public function testSendTextMessageIntegration(): void
    {
        // 测试通过服务发送文本消息的完整流程
    ...
    public function testSendTextMessageRequestCreation(): void
    {
