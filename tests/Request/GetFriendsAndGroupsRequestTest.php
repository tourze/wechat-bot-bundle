 ...
 * @internal
 */
#[CoversClass(GetFriendsAndGroupsRequest::class)]
final class GetFriendsAndGroupsRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetFriendsAndGroupsRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetFriendsAndGroupsRequest(
            $this->apiAccount,
            'device123'
        );
    }
