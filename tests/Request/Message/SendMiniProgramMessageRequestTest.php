...
namespace Tourze\WechatBotBundle\Tests\Request\Message;

use HttpClientBundle\Tests\Request\RequestTestCase;
use PHPUnit\Framework\Attributes\CoversClass;
use Tourze\WechatBotBundle\Entity\WeChatApiAccount;
use Tourze\WechatBotBundle\Request\Message\SendMiniProgramMessageRequest;

/**
 * @internal
 */
#[CoversClass(SendMiniProgramMessageRequest::class)]
final class SendMiniProgramMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SendMiniProgramMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SendMiniProgramMessageRequest(
            $this->apiAccount,
            'device123',
            'wxid123',
            'appid123',
