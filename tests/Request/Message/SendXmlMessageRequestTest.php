...
use Tourze\WechatBotBundle\Request\Message\SendXmlMessageRequest;

/**
 * @internal
 */
#[CoversClass(SendXmlMessageRequest::class)]
final class SendXmlMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SendXmlMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SendXmlMessageRequest(
            $this->apiAccount,
            'device123',
            'wx_user_123',
            '<xml>test xml content</xml>'
        );
    }
