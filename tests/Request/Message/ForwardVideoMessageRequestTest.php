...
use Tourze\WechatBotBundle\Request\Message\ForwardVideoMessageRequest;

/**
 * @internal
 */
#[CoversClass(ForwardVideoMessageRequest::class)]
final class ForwardVideoMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ForwardVideoMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ForwardVideoMessageRequest(
            $this->apiAccount,
            'device123',
            'wxid123',
            '<xml>test</xml>'
