...
use Tourze\WechatBotBundle\Request\Message\SetMessageFilterRequest;

/**
 * @internal
 */
#[CoversClass(SetMessageFilterRequest::class)]
final class SetMessageFilterRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SetMessageFilterRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SetMessageFilterRequest(
            $this->apiAccount,
            'device123',
