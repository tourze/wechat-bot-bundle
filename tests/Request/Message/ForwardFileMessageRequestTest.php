...
use Tourze\WechatBotBundle\Request\Message\ForwardFileMessageRequest;

/**
 * @internal
 */
#[CoversClass(ForwardFileMessageRequest::class)]
final class ForwardFileMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ForwardFileMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ForwardFileMessageRequest(
            $this->apiAccount,
            'device123',
            'wxid123',
            '<xml>test</xml>'
