...
use Tourze\WechatBotBundle\Request\Message\SendEmojiMessageRequest;

/**
 * @internal
 */
#[CoversClass(SendEmojiMessageRequest::class)]
final class SendEmojiMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SendEmojiMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SendEmojiMessageRequest(
            $this->apiAccount,
            'device123',
            'wxid123',
            'emoji_md5_hash'
