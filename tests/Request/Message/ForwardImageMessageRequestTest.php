...
use Tourze\WechatBotBundle\Request\Message\ForwardImageMessageRequest;

/**
 * @internal
 */
#[CoversClass(ForwardImageMessageRequest::class)]
final class ForwardImageMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ForwardImageMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ForwardImageMessageRequest(
            $this->apiAccount,
            'device123',
            'wxid123',
            '<xml>test</xml>'
