...
use Tourze\WechatBotBundle\Request\Message\ForwardLinkMessageRequest;

/**
 * @internal
 */
#[CoversClass(ForwardLinkMessageRequest::class)]
final class ForwardLinkMessageRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ForwardLinkMessageRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ForwardLinkMessageRequest(
            $this->apiAccount,
            'device123',
            'wxid123',
            '<xml>test</xml>'
