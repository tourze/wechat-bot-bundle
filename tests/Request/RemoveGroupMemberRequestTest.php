 ...
 * @internal
 */
#[CoversClass(RemoveGroupMemberRequest::class)]
final class RemoveGroupMemberRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private RemoveGroupMemberRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new RemoveGroupMemberRequest(
            $this->apiAccount,
            'device123',
            'chatroom888@chatroom',
            'user1,user2'
        );
    }
