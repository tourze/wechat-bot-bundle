...
use Tourze\WechatBotBundle\Request\Receive\CancelMessageFilterRequest;

/**
 * @internal
 */
#[CoversClass(CancelMessageFilterRequest::class)]
final class CancelMessageFilterRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private CancelMessageFilterRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new CancelMessageFilterRequest(
            $this->apiAccount,
            'device123'
        );
    }
