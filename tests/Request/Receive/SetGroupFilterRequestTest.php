...
use Tourze\WechatBotBundle\Request\Receive\SetGroupFilterRequest;

/**
 * @internal
 */
#[CoversClass(SetGroupFilterRequest::class)]
final class SetGroupFilterRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SetGroupFilterRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SetGroupFilterRequest(
            $this->apiAccount,
            'device123',
