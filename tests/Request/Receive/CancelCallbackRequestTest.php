 ...
 * @internal
 */
#[CoversClass(CancelCallbackRequest::class)]
final class CancelCallbackRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private CancelCallbackRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new CancelCallbackRequest(
            $this->apiAccount,
            'device123'
        );
    }
