...
use Tourze\WechatBotBundle\Request\Receive\GetGroupFiltersRequest;

/**
 * @internal
 */
#[CoversClass(GetGroupFiltersRequest::class)]
final class GetGroupFiltersRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetGroupFiltersRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetGroupFiltersRequest(
            $this->apiAccount,
            'device123'
        );
    }
