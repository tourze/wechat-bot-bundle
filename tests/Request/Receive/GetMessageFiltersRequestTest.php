...
use Tourze\WechatBotBundle\Request\Receive\GetMessageFiltersRequest;

/**
 * @internal
 */
#[CoversClass(GetMessageFiltersRequest::class)]
final class GetMessageFiltersRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetMessageFiltersRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetMessageFiltersRequest(
            $this->apiAccount,
            'device123'
        );
    }
