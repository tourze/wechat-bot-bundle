...
use Tourze\WechatBotBundle\Request\Receive\DeleteGroupFilterRequest;

/**
 * @internal
 */
#[CoversClass(DeleteGroupFilterRequest::class)]
final class DeleteGroupFilterRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private DeleteGroupFilterRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new DeleteGroupFilterRequest(
            $this->apiAccount,
            'device123',
            ['group1' => 'group123', 'group2' => 'group456']
        );
    }
