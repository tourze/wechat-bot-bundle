...
use Tourze\WechatBotBundle\Request\Account\ResetApiTokenRequest;

/**
 * @internal
 */
#[CoversClass(ResetApiTokenRequest::class)]
final class ResetApiTokenRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ResetApiTokenRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ResetApiTokenRequest($this->apiAccount);
    }
