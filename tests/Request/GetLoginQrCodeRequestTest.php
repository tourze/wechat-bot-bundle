 ...
 * @internal
 */
#[CoversClass(GetLoginQrCodeRequest::class)]
final class GetLoginQrCodeRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetLoginQrCodeRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetLoginQrCodeRequest(
            $this->apiAccount,
            'device123'
        );
    }
