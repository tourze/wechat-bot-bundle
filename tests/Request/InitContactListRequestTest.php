 ...
 * @internal
 */
#[CoversClass(InitContactListRequest::class)]
final class InitContactListRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private InitContactListRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new InitContactListRequest(
            $this->apiAccount,
            'device123'
        );
    }
