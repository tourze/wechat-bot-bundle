...
use Tourze\WechatBotBundle\Request\SetGroupAnnouncementRequest;

/**
 * @internal
 */
#[CoversClass(SetGroupAnnouncementRequest::class)]
final class SetGroupAnnouncementRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SetGroupAnnouncementRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SetGroupAnnouncementRequest(
            $this->apiAccount,
            'device123',
            'chatroom999@chatroom',
