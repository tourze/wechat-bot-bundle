...
use Tourze\WechatBotBundle\Request\ReLoginRequest;

/**
 * @internal
 */
#[CoversClass(ReLoginRequest::class)]
final class ReLoginRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private ReLoginRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new ReLoginRequest(
            $this->apiAccount,
            'device123'
        );
    }
