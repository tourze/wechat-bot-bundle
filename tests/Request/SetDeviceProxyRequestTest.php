 ...
 * @internal
 */
#[CoversClass(SetDeviceProxyRequest::class)]
final class SetDeviceProxyRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SetDeviceProxyRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SetDeviceProxyRequest(
            $this->apiAccount,
            'device123'
        );
    }
