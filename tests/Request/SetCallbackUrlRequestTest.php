...
use Tourze\WechatBotBundle\Request\SetCallbackUrlRequest;

/**
 * @internal
 */
#[CoversClass(SetCallbackUrlRequest::class)]
final class SetCallbackUrlRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private SetCallbackUrlRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new SetCallbackUrlRequest(
            $this->apiAccount,
            'device123'
        );
    }
