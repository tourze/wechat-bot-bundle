...
use Tourze\WechatBotBundle\Request\GetOnlineDevicesRequest;

/**
 * @internal
 */
#[CoversClass(GetOnlineDevicesRequest::class)]
final class GetOnlineDevicesRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetOnlineDevicesRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetOnlineDevicesRequest(
            $this->apiAccount
        );
    }
    ...
    {
        $this->assertEquals('open/queryLoginDevice', $this->request->getRequestPath());
    }
}
