 ...
 * @internal
 */
#[CoversClass(GetGroupDetailRequest::class)]
final class GetGroupDetailRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private GetGroupDetailRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new GetGroupDetailRequest(
            $this->apiAccount,
            'device123',
            'group456'
        );
    ...
    {
        $this->assertEquals('open/getGroupDetail', $this->request->getRequestPath());
    }
