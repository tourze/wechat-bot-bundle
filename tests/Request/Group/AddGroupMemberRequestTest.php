 ...
 * @internal
 */
#[CoversClass(AddGroupMemberRequest::class)]
final class AddGroupMemberRequestTest extends RequestTestCase
{
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new AddGroupMemberRequest(
            $this->apiAccount,
            'device123',
            'group456',
            'memberWxId789'
    ...
    {
        $this->assertEquals('group456', $this->request->getChatRoomId());
    }

    public function testGetUserList(): void
    {
        $this->assertEquals('memberWxId789', $this->request->getUserList());
    }
    ...
    public function testGetRequestOptions(): void
    {
        ...
        $this->assertEquals('group456', $options['json']['chatRoomId']);
        $this->assertEquals('memberWxId789', $options['json']['userList']);
    }
}
