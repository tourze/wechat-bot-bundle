 ...
 * @internal
 */
#[CoversClass(UpdateGroupNameRequest::class)]
final class UpdateGroupNameRequestTest extends RequestTestCase
{
    private WeChatApiAccount $apiAccount;

    private UpdateGroupNameRequest $request;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->request = new UpdateGroupNameRequest(
            $this->apiAccount,
            'device123',
    ...
    public function testGetChatRoomName(): void
    {
        $this->assertEquals('测试群组名称', $this->request->getChatRoomName());
    }

    public function testGetRequestPath(): void
    {
        $this->assertEquals('open/modifyChatroomName', $this->request->getRequestPath());
    }
    ...
    public function testGetRequestOptions(): void
    {
        ...
        $this->assertEquals('测试群组名称', $options['json']['chatRoomName']);
    }
}
