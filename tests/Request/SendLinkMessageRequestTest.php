 ...
 * @internal
 */
#[CoversClass(SendLinkMessageRequest::class)]
#[RunTestsInSeparateProcesses]
final class SendLinkMessageRequestTest extends AbstractIntegrationTestCase
{
    ...
    public function testSendLinkMessageIntegration(): void
    {
        // 测试通过服务发送链接消息的完整流程
        $result = $this->messageService->sendLinkMessage(
            $this->wechatAccount,
            'target_wx_id',
            'Test Link Title',
    ...
    public function testSendLinkMessageRequestCreation(): void
    {
